VERSION 5.00
Begin VB.Form BooksReadForm 
   Caption         =   "Libros leìdos"
   ClientHeight    =   10305
   ClientLeft      =   165
   ClientTop       =   510
   ClientWidth     =   14265
   ...
   End
End
Attribute VB_Name = "BooksReadForm"
...
TotalBooks = CountReadedBooks(GetCurrentUser.Id)
    ...
    Set RsBooks = GetReadedBooks(GetCurrentUser.Id)
